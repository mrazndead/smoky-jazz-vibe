...
const MartiniGlass = ({ isPlaying }: MartiniGlassProps) => {
  return (
    <div className="relative w-40 h-24 flex-shrink-0 flex items-center justify-center">
      {/* First Martini Glass */}
      <div className="relative w-20 h-24 opacity-50 hover:opacity-70 transition-opacity duration-700">
      ...
      <div className="relative w-20 h-24 opacity-50 hover:opacity-70 transition-opacity duration-700 ml-4">
        <svg viewBox="0 0 80 100" className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
          <defs>
